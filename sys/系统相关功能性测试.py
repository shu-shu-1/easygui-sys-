...
# with open(r'D:\my_work\Python\sys\测试.txt','a') as f:
#     f.write('app')
# with open(r'D:\my_work\Python\sys\测试.txt','rb') as f:
#     c=f.write()
# print(c)
# from easygui import *
# print(fileopenbox(default='text.txt'))
# user_name='test'
# c1 = choicebox(msg='你好，' + user_name + '\n请选择功能：', choices=['1.txt文件编辑', '2.其他文件管理'])
# print(c1)
# execfile('一键搜歌/一键搜歌GUI.py')
# import os

# os.system("py 一键搜歌/一键搜歌GUI.py")
import tkinter
